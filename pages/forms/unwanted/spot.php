      ...
      <div class="navbar-menu-wrapper d-flex align-items-center">
        <ul class="navbar-nav navbar-nav-left header-links d-none d-md-flex">
          ...
          <li class="nav-item active">
            <a href="#" class="nav-link"><i class="mdi mdi-email-outline"></i>spot</a>
          </li>
          <li class="nav-item">
              ...
              <div class="row flex-grow">
                <div class="col-12">
                 ...
                 add here
                  ...
                  <form class="forms-sample" action="addingspot.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-12 stretch-card">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form class="forms-sample"  action="spotimgupload.php" enctype="multipart/form-data" method="post">
 ...
 <label>File upload</label>
                      ...
                      <div class="input-group col-xs-12">
                        ...
                        <span class="input-group-append">
                         ...
                         <button type="submit" class="btn btn-primary btn-rounded btn-fw" >upload</button>
             ...
             <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="updatespot.php" method="POST">
				  <div class="form-group">
                 ...
                 delete details from hotel
                  ...
                  <form class="forms-sample" action="deletespot.php" method="POST">
                    <div class="form-group">
                      <label for="exampleInputName1">id</label>
                      <input type="text" class="form-control" name="id" placeholder="id">
                    </div>
...
include('conn.php');
$query = mysqli_query($con, "SELECT * FROM `spot`");
?>

<table cellpadding="5" border="1">
<tr><th>Location id</th><th>Location Name</th><th>place</th><th>details</th><th>logitude</th><th>latitude</th></tr>

<?php
while($row = mysqli_fetch_array($query))
{ 
echo "<tr><td>".$row['id']."</td><td>".$row['name']."</td><td>".$row['place']."</td><td>".$row['details']."</td><td>".$row['logitude']."</td><td>".$row['latitude']."</td></tr>"; 
}?>
